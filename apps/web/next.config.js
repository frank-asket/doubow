...
/**
 * Next only auto-loads `.env*` from the current app directory. In this monorepo,
...
const legacyFrontendDir = path.join(repoRoot, 'frontend')
const fromFiles = {
  ...loadEnvFromDir(repoRoot),
  ...loadEnvFromDir(legacyFrontendDir),
  ...loadEnvFromDir(frontendDir),
}
