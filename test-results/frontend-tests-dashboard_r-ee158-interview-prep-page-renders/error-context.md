...
- Name: frontend/tests/dashboard_routes.spec.ts >> dashboard routes smoke >> interview prep page renders
- Location: frontend/tests/dashboard_routes.spec.ts:84:7
...
Call log:
  - navigating to "/prep", waiting until "load"
