...
- Name: frontend/tests/dashboard_live.spec.ts >> dashboard routes live backend >> approvals page renders with live backend
- Location: frontend/tests/dashboard_live.spec.ts:15:7
...
Call log:
  - navigating to "/approvals", waiting until "load"
