...
Usage (from anywhere):
  python backend/api_gateway/scripts/migrate.py
  python backend/api_gateway/scripts/migrate.py current
  python backend/api_gateway/scripts/migrate.py downgrade -1
