...
- Name: frontend/tests/dashboard_live.spec.ts >> dashboard routes live backend >> discover page renders with live backend
- Location: frontend/tests/dashboard_live.spec.ts:4:7
