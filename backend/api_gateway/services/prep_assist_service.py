...
from services.llm_prompts import prep_assist_company_brief_system, prep_assist_star_system
...
async def generate_prep_assist_text(
    ...
    if kind == "company_brief":
        system = prep_assist_company_brief_system()
        user = (
        ...
        system = prep_assist_star_system()
        user = (
